...
![Figure 2: Input genes are BAG1 and NCK2; the chosen organism is Homo sapiens.](./Figure2.png)
...
![Figure 3: A network view for chosen isoforms of BAG1 and NCK2.](./Figure3.png)
...
![Figure 4: a tabular view on isoforms of BAG1 and NCK2.A transcript BAG-207 possibly lost a PPI due to alternative
splicing that leads to removing the part of the protein that encodes a domain PF02179. A transcript NCK-202 also lost
a PPI due to splicing of domains PF00017 and PF14604.](./Figure4.png)
...
![Figure 5: General information about a transcript](./Figure5.png)
...
![](./Figure6A.png)
![Figure 6: Comparing BAG1-210 and BAG-207 isoforms, one can detect that these isoforms differ in exons that encode a
domain PF02179 as well as exons that contain interacting residues](./Figure6B.png)


![](./Figure7A.png)
![Figure 7: Comparing NCK-201 and NCK-202 isoforms, one can detect that these isoforms differ in exons that
encode domains PF14604, the second PF00018, PF00017 as well as exons that contain interacting residues](./Figure7B.png)
...
![Figure 8: PPI-DDI view for BAG1-207 depicts possibly missing interactions with BAG3, HSPA1A, HSPA4, and 
HSPA8](./Figure8.png)
...
![Figure 9: Interaction View of BAG1-207 isoform. An interaction with HSPA8 might be lost due to alternative
splicing of PF02179](./Figure9.png)

Domain View (Figure 10) shows all interactors known for a particular domain.

![Figure 10: Splicing out a domain PF02179 in the isoform BAG1-207 leads to missing PPIs with BAG3, HSPA1A, 
HSPA4, and HSPA8](./Figure10.png)


Other isoforms View (Figure 11) again depicts the table of all other known protein-coding isoforms of a gene.

![Figure 11: All transcripts of BAG1](./Figure11.png)
...
![Figure 12: An input exon is exon ENSE00003569638 from BAG1; the organism is Homo sapiens](./Figure12.png)
...
![Figure 13: A DomainView for and exon ENSE00003569638](./Figure13.png)

A table "Proteins that use this exon" (Figure 14) reports the list of all protein-coding isoforms that encodes this exon:

![Figure 14: A table "Proteins that use this exon" for an exon ENSE00003569638](./Figure14.png)
...
![Figure 15: An example input for Network-level analysis](./Figure15.png)
...
![Figure 16: An example output for Network-level analysis](./Figure16.png)
...
![Figure 17: NEASE starting page](./FigureNEASE.png)
